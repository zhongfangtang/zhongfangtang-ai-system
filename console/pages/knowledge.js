...
export async function render(el) {
  const kbs = [
    ...
    { name:'🎓 AEUA国际芳香疗法师', ref:'AEUA欧洲芳香疗法学会·屈兵高级讲师', count:'Module1-8全课程+国际认证' },
    { name:'📖 1+X芳香疗法师', ref:'教育部1+X证书制度·考评员培训', count:'初/中/高三级+师资+考评员' },
  ];
  ...
  el.innerHTML = `
    ...
    <div class="card mt16" style="border-color:var(--gold);background:linear-gradient(135deg,rgba(212,168,83,.06),transparent)">
      ...
      <div class="meta" style="line-height:2">
        ...
        <b>法人：屈兵</b><br>
        中医芳香疗法师（高级）| 康复理疗师 | AEUA会员<br>
        AEUA国际芳香疗法师·高级讲师 | AEUA湖北省级代理·培训学校校长<br>
        1+X芳香疗法师·师资+考评员 | 九体辨识复方精油+28养复方精油自研配方<br>
        <b>四大代理品牌：</b>纤姿达(流量端) + 腕家H1(监测端) + 美罗国际(内调端) + AEUA+1+X(认证端)<br>
