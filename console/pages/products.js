...
const PRODUCTS = {
  ...
  meiluo: {
    ...
    items: [
      { name: '灵芝孢子粉/孢子油/多糖胶囊', type: '保健品', price: '咨询', desc: '灵芝多糖+灵芝三萜+灵芝酸。功效：提升免疫力、抗疲劳、改善睡眠、保肝护肝、延缓衰老。适用：免疫力低下、易疲劳、睡眠不佳、肝功能异常。', tags: ['免疫力','核心'] },
      { name: '破壁松花粉/松花粉片', type: '保健品', price: '咨询', desc: '200余种营养素，22种氨基酸+14种维生素+30多种矿物质。功效：全面营养、调节内分泌、改善皮肤、增强体力、润肠通便。适用：营养不良、内分泌失调、皮肤粗糙。', tags: ['全营养','基础'] },
      { name: '猴头菇多糖胶囊/口服液', type: '保健品', price: '咨询', desc: '猴头菇多糖+猴头菇酮。功效：养胃护胃、修复胃黏膜、促进消化、增强食欲、保护神经。适用：胃部不适、消化不良、慢性胃炎。', tags: ['养胃','消化'] },
      { name: '冬虫夏草多糖胶囊/口服液', type: '保健品', price: '咨询', desc: '虫草多糖+虫草酸+虫草素+腺苷。功效：补肺益肾、增强免疫、抗疲劳、改善心脑血管、延缓衰老。适用：肺肾两虚、免疫力低下、易感冒、慢性支气管炎。', tags: ['高端','滋补','肺肾'] },
    ],
  },
  xianzida: {
    title: '纤姿达 · 本草植萃外养体系（抖音云连锁）',
    items: [
      { name: '本草植萃液（多配方）', type: '外用', price: '咨询', desc: '艾草/生姜/当归/红花/迷迭香/薄荷6种本草萃取。功效：温经通络、促进代谢、排水消肿、舒缓疲劳、辅助塑形。适用：腹部/腿部/手臂/背部。配合按摩至吸收，每日1-2次。', tags: ['核心','多配方'] },
      { name: '植萃平衡霜', type: '外用', price: '咨询', desc: '植物甾醇+维生素E+透明质酸+烟酰胺+积雪草提取物。功效：紧致塑形、滋润保湿(72h)、改善橘皮、修复屏障、提亮肤色。适用：皮肤松弛、橘皮组织、干燥缺水。', tags: ['保湿','紧致'] },
      { name: '居家养护套组', type: '套装', price: '咨询', desc: '植萃液100ml+平衡霜100g+热敷盐包+经络刷+刮痧板+使用手册。适用：纯居家/到店维护期/出差随身。每周3-5次，每次30-45分钟。', tags: ['套装','居家'] },
      { name: '热敷盐包（海盐+本草）', type: '工具', price: '咨询', desc: '天然死海盐+艾草粉+生姜粉+川芎粉。功效：温经散寒、促进循环、缓解酸痛、辅助精油吸收率提升3-5倍。微波加热1-2分钟，热敷15-20分钟。', tags: ['温敷','辅助'] },
    ],
  },
  qushi: {
